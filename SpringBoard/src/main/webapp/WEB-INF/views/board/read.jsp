	...
	<div class="box box-primary">
		...
		<div class="box-body">
			<div class="form-group">
				...
				<input type="text" name="title" class="form-control" id="exampleInputEmail1" value="${vo.bno }" readonly>
			</div>
			<div class="form-group">
				<label for="exampleInputEmail1">제 목</label>
				<input type="text" name="title" class="form-control" id="exampleInputEmail1" value="${vo.title }" readonly>
			</div>
			<div class="form-group">
...
// 			console.log(formObj);
			//수정버튼(bno가지고 submit - /board/modify)
			...
			//삭제 버튼 (bno가지고 submit-/board/remove)
